...
const SQL = {
  CLIENT: {
    FIND_CLIENT_REGIONS_BY_USER_ID : `SELECT fias_id as "fiasId",  region_name as "regionName" FROM pa_client_service.client_regions  WHERE user_id = $1 and blocked is null`,
    SAVE_CLIENT_REGIONS_BY_USER_ID : `INSERT INTO  pa_client_service.client_regions  (fias_id, region_name, user_id) VALUES ($1,$2,$3) 
    ON CONFLICT (user_id, fias_id) DO UPDATE SET
    blocked = null
    RETURNING *`,    
