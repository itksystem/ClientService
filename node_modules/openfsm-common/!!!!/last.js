...
const COMMON_LOGON_FAILED_PAGE = path.join(COMMON_PATH_TO_PAGES, 'logon-failed.hbs'); // Страница при неверно введенном пароле
const COMMON_FORGOT_PASSWORD_PAGE = path.join(COMMON_PATH_TO_PAGES, 'forgot-password.hbs'); // Восстановление пароля
...
COMMON_LOGON_FAILED_PAGE,
COMMON_FORGOT_PASSWORD_PAGE,
